...
import com.manual.mediation.library.foflib.activities.AppCompatBaseActivity
import com.manual.mediation.library.foflib.adMobAdClasses.AdMobBannerAdSplash
...
import com.manual.mediation.library.foflib.callingClasses.WalkThroughScreensConfiguration
import com.manual.mediation.library.foflib.callingClasses.WelcomeScreensConfiguration
import com.manual.mediation.library.foflib.data.Language
import com.manual.mediation.library.foflib.data.WalkThroughItem
import com.manual.mediation.library.foflib.utils.FirebaseCommonTracker
...
import com.sot.foflib.databinding.ActivitySotstartTestBinding
import com.urdu_keyboard.utilityClasses.RemoteConfigConstTest

class FOFTestActivity : AppCompatBaseActivity() {
    ...
    private fun startFirstOpenFlow() {
        Log.i("FOFTestActivity", "splash_scr")
                ...
                fetchAdIDS(
                    remoteConfigOperationsCompleted = {
                        sotAdsConfigurations.setRemoteConfigData(
                            activityContext = this@FOFTestActivity,
        ...
        val languageScreensConfiguration = LanguageScreensConfiguration.Builder()
            ...
            .setDrawableColors(
                selectedDrawable = AppCompatResources.getDrawable(
                    this,
                    com.manual.mediation.library.foflib.R.drawable.ad_att_bg
                )!!,
                ...
                selectedRadio = AppCompatResources.getDrawable(
                    this,
                    com.manual.mediation.library.foflib.R.drawable.ic_radio_button_checked
                )!!,
                unSelectedRadio = AppCompatResources.getDrawable(
                    this,
                    com.manual.mediation.library.foflib.R.drawable.ic_radio_button_unchecked
                )!!,
                tickSelector = AppCompatResources.getDrawable(
                    this,
                    com.manual.mediation.library.foflib.R.drawable.ic_done
                )!!,
    ...
    private fun setUpWelcomeScreen(context: Context): View {
        ...
        txtWallpapers.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_wallpaper")
        ...
        txtEditor.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_urdu_editor")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        txtLiveThemes.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_live_themes")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        txtPhotoOnKeyboard.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_photo_on_keyboard")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        txtPhotoTranslator.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_photo_translator")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        txtInstantSticker.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_instant_stickers")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        txtLiveTranslator.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_live_translator")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        txtUrduSticker.setOnClickListener {
            Log.i("FOFTestActivity", "survey_scr_check_urdu_stickers")
            if (isDuplicateScreenStarted) {
                SOTAdsManager.showWelcomeDupScreen()
            }
            isDuplicateScreenStarted = false
        ...
        nextButton.setOnClickListener {
            if (txtWallpapersBool || txtEditorBool ||
                ...
                Log.i("FOFTestActivity", "survey2_scr")
                Log.i("FOFTestActivity", "survey2_scr_tap_continue")
                SOTAdsManager.completeWelcomeScreens()
            } else {
                Log.i("FOFTestActivity", "survey1_scr")
                Log.i("FOFTestActivity", "survey1_scr_tap_continue")
                if (isDuplicateScreenStarted) {
                    SOTAdsManager.showWelcomeDupScreen()
                }
                isDuplicateScreenStarted = false
    ...
    private fun getWalkThroughList(context: Context): ArrayList<WalkThroughItem> {
        ...
        return arrayListOf(
            WalkThroughItem(
                ...
                headingColor = com.manual.mediation.library.foflib.R.color.redLib,
                descriptionColor = com.manual.mediation.library.foflib.R.color.yellowLib,
                nextColor = com.manual.mediation.library.foflib.R.color.orangeLib,
                drawableResId = com.manual.mediation.library.foflib.R.drawable.pakistan,
            ...
            WalkThroughItem(
                ...
                descriptionColor = com.manual.mediation.library.foflib.R.color.yellowLib,
                nextColor = com.manual.mediation.library.foflib.R.color.orangeLib,
                drawableResId = com.manual.mediation.library.foflib.R.drawable.img2,
                drawableBubbleResId = R.drawable.ic_launcher_foreground,
                viewBackgroundColor = R.color.red,
                imageScale = 1
            ),
    ...
    private fun fetchAdIDS(remoteConfigOperationsCompleted: (HashMap<String, Any>) -> Unit) {
        if (NetworkCheck.isNetworkAvailable(this@FOFTestActivity)) {
            saveAllValues()
