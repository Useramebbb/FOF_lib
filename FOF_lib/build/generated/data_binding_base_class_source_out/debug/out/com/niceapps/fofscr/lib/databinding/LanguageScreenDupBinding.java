...
public final class LanguageScreenDupBinding implements ViewBinding {
  ...
  @NonNull
  public static LanguageScreenDupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LanguageScreenDupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.language_screen_dup, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LanguageScreenDupBinding bind(@NonNull View rootView) {
