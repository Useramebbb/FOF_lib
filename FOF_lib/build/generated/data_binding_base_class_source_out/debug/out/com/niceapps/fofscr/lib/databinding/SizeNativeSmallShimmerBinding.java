...
public final class SizeNativeSmallShimmerBinding implements ViewBinding {
  @NonNull
  ...
  private SizeNativeSmallShimmerBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static SizeNativeSmallShimmerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SizeNativeSmallShimmerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.size_native_small_shimmer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SizeNativeSmallShimmerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SizeNativeSmallShimmerBinding((NativeAdView) rootView, adAppIcon, adAttribute,
