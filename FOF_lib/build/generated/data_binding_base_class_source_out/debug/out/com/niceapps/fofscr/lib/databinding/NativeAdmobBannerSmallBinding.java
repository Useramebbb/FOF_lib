...
public final class NativeAdmobBannerSmallBinding implements ViewBinding {
  @NonNull
  ...
  private NativeAdmobBannerSmallBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static NativeAdmobBannerSmallBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NativeAdmobBannerSmallBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.native_admob_banner_small, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NativeAdmobBannerSmallBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdmobBannerSmallBinding((NativeAdView) rootView, adAppIcon, adAttribute,
