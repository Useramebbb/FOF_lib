...
public final class AdmobNativeSmallShimmerBinding implements ViewBinding {
  @NonNull
  ...
  private AdmobNativeSmallShimmerBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static AdmobNativeSmallShimmerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdmobNativeSmallShimmerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.admob_native_small_shimmer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdmobNativeSmallShimmerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdmobNativeSmallShimmerBinding((NativeAdView) rootView, adAppIcon, adAttribute,
