...
public final class SizeNativeMediumShimmerBinding implements ViewBinding {
  @NonNull
  ...
  private SizeNativeMediumShimmerBinding(@NonNull NativeAdView rootView,
  ...
  @NonNull
  public static SizeNativeMediumShimmerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SizeNativeMediumShimmerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.size_native_medium_shimmer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SizeNativeMediumShimmerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SizeNativeMediumShimmerBinding((NativeAdView) rootView, adAppIcon, adAttribute,
