...
public final class MetaNativeMediaviewMediumBinding implements ViewBinding {
  @NonNull
  ...
  private MetaNativeMediaviewMediumBinding(@NonNull NativeAdLayout rootView,
  ...
  @NonNull
  public static MetaNativeMediaviewMediumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MetaNativeMediaviewMediumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.meta_native_mediaview_medium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MetaNativeMediaviewMediumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MetaNativeMediaviewMediumBinding((NativeAdLayout) rootView, adChoicesContainer,
